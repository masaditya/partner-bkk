    ...
    <div class="p-4 mx-auto max-w-screen-2xl md:p-6 2xl:p-10">
        ...
        <div class="flex flex-col gap-3 mb-4 sm:flex-row sm:items-center sm:justify-between">
            <div class="flex justify-end text-sm">
                <a href="{{ route('partners.export.excel') }}" class="flex items-center gap-2 px-4 py-2 text-white bg-green-300 rounded hover:bg-green-400">
                ...
                <a href="{{ route('partners.export.pdf') }}" class="flex items-center gap-2 px-4 py-2 ml-2 text-white bg-red-300 rounded hover:bg-red-400">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                                    <p class="text-gray-700 dark:text-white">{{ $partner->company_name }}</p>
                                </td>
                                <td class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                                    <p class="text-gray-700 dark:text-white">{{ $partner->companyIndustry->name }}</p>
                                </td>
                                <td class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                                    <p class="text-gray-700 dark:text-white">{{ $partner->company_city }}</p>
                                </td>
                                <td class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
