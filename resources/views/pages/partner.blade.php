    ...
    <div class="p-4 mx-auto max-w-screen-2xl md:p-6 2xl:p-10">
        ...
        <div class="flex flex-col gap-3 mb-4 sm:flex-row sm:items-center sm:justify-between">
            <div class="flex justify-end text-sm">
                <a href="{{ route('partners.export.excel') }}" class="bg-green-300 text-white py-2 px-4 rounded hover:bg-green-400">
                ...
                <a href="{{ route('partners.export.pdf') }}" class="bg-red-300 text-white py-2 px-4 ml-2 rounded hover:bg-red-400">
