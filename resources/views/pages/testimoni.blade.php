    ...
    <div class="p-4 mx-auto max-w-screen-2xl md:p-6 2xl:p-10">
        ...
        <div class="flex flex-col gap-3 mb-6 sm:flex-row sm:items-center sm:justify-between">
            ...
            <nav>
                <ol class="flex items-center gap-2">
                    ...
                    <li class="font-medium text-blue-500">Testimoni</li>
                    <li class="font-medium text-blue-500">Jurusan</li>
                </ol>
            </nav>
        </div>
        <!-- Breadcrumb End -->
        ...
        <div class="flex flex-col gap-3 mb-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <button type="button"
                ...
                aria-haspopup="dialog" aria-expanded="false" aria-controls="hs-add-data-testimoni-modal"
        ...
        <div class="flex flex-col gap-10">
            ...
            <div
                ...
                <div class="max-w-full overflow-x-auto">
                    <table id="dataTableTestimoni" class="w-full table-auto">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                                    <p class="text-gray-700 dark:text-white">{{ $testimoni->user->name }}</p>
                                </td>
                                <td class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                                    <p class="text-gray-700 dark:text-white">{{ $testimoni->quote }}</p>
                                </td>
                                ...
                                <td class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                                    <div class="flex items-center space-x-3.5">
                                        <button type="button" class="hover:text-primary dark:text-gray-100" aria-haspopup="dialog"
                                            aria-expanded="false" aria-controls="hs-delete-data-{{ $testimoni->id }}"
                                            data-hs-overlay="#hs-delete-data-{{ $testimoni->id }}">
                                        ...
                                        aria-haspopup="dialog"
                                            aria-expanded="false" aria-controls="hs-edit-data-{{ $testimoni->id }}"
                                            data-hs-overlay="#hs-edit-data-{{ $testimoni->id }}">
                            ...
                            @include('components.modal.testimoni.edit')
                            @include('components.modal.testimoni.delete')
                            @endforeach
                        </tbody>
                    </table>
                </div>
...
@include('components.modal.testimoni.add')
@endsection
