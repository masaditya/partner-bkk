        ...
        <div class="flex flex-col gap-3 mb-6 sm:flex-row sm:items-center sm:justify-between">
            ...
            <nav>
                <ol class="flex items-center gap-2">
                    ...
                    <li class="font-medium text-blue-500">Lowongan Pekerjaan</li>
                </ol>
            </nav>
        </div>
        <!-- Breadcrumb End -->
                                ...
                                <td class="border-b border-[#eee] dark:border-strokedark">
                                    <div class="flex items-center space-x-3.5">
                                        <button type="button" class="hover:text-primary dark:text-gray-100" aria-haspopup="dialog"
                                            aria-expanded="false" aria-controls="hs-delete-data-{{ $occupation->id }}"
                                            data-hs-overlay="#hs-delete-data-{{ $occupation->id }}">
                                        ...
                                        <a href="{{ route('occupation.edit', $occupation->id) }}" class="hover:text-primary dark:text-gray-100">
