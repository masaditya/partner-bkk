@extends('layouts.app')
@section('title', 'Perusahaan-Industri')
    ...
    <div class="p-4 mx-auto max-w-screen-2xl md:p-6 2xl:p-10">
        ...
        <div class="flex flex-col gap-3 mb-6 sm:flex-row sm:items-center sm:justify-between">
            ...
            <nav>
                <ol class="flex items-center gap-2">
                    ...
                    <li class="font-medium text-blue-500">Industri Perusahaan</li>
                </ol>
            </nav>
        </div>
        <!-- Breadcrumb End -->
        ...
        <div class="flex flex-col gap-3 mb-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <button type="button"
                ...
                aria-haspopup="dialog" aria-expanded="false" aria-controls="hs-add-data-industry-modal"
                data-hs-overlay="#hs-add-data-industry-modal">
                <span>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="size-[18px]">
                    <path d="M10.75 4.75a.75.75 0 0 0-1.5 0v4.5h-4.5a.75.75 0 0 0 0 1.5h4.5v4.5a.75.75 0 0 0 1.5 0v-4.5h4.5a.75.75 0 0 0 0-1.5h-4.5v-4.5Z" />
                    </svg>
                </span>
                Tambah Industri Perusahaan
            </button>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                                    <p class="text-gray-700 dark:text-white">{{ $industry->name }}</p>
                                </td>
                                ...
                                <td class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                                    <div class="flex items-center space-x-3.5">
                                        <button type="button" class="hover:text-primary dark:text-gray-100" aria-haspopup="dialog"
                                            aria-expanded="false" aria-controls="hs-delete-data-{{ $industry->id }}"
                                            data-hs-overlay="#hs-delete-data-{{ $industry->id }}">
                                        ...
                                        aria-haspopup="dialog"
                                            aria-expanded="false" aria-controls="hs-edit-data-{{ $industry->id }}"
                                            data-hs-overlay="#hs-edit-data-{{ $industry->id }}">
                            ...
                            @include('components.modal.industry.edit')
                            @include('components.modal.industry.delete')
                            @endforeach
                        </tbody>
                    </table>
                </div>
