                    ...
                    <table id="dataTableBkk" class="w-full table-auto">
                        ...
                        <tbody>
                            ...
                            <tr class="text-sm">
                                ...
                                <td class="border-b border-[#eee] dark:border-strokedark">
                                    <p class="text-gray-700 dark:text-white">{{ $article->title }}</p>
                                </td>
                                <td class="border-b border-[#eee] dark:border-strokedark">
                                    <p class="text-gray-700 dark:text-white">{{ $article->category->name }}</p>
                                </td>
                                 <td class="border-b border-[#eee] dark:border-strokedark">
                            ...
                            @include('components.modal.article.delete')
                            @endforeach
                        </tbody>
                    </table>
                </div>
