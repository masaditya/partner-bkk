    ...
    <div class="p-4 mx-auto max-w-screen-2xl md:p-6 2xl:p-10">
        ...
        <div class="flex flex-col gap-3 mb-4 sm:flex-row sm:items-center sm:justify-between">
            <div class="flex justify-end text-sm">
                <a href="{{ route('user.export.excel') }}" class="px-4 py-2 text-white bg-green-300 rounded hover:bg-green-400">
                ...
                <a href="{{ route('user.export.pdf') }}" class="px-4 py-2 ml-2 text-white bg-red-300 rounded hover:bg-red-400">
