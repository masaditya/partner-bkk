<div id="hs-update-password-data-{{ $user->id }}"
    class="hs-overlay hidden size-full fixed top-0 start-0 z-[2000] overflow-x-hidden overflow-y-auto pointer-events-none"
    role="dialog" tabindex="-1" aria-labelledby="#hs-update-password-data-{{ $user->id }}-label">
    <div
        ...
        <div
            ...
            <div class="flex items-center justify-between px-4 py-3 border-b dark:border-neutral-700">
                ...
                <button type="button"
                    ...
                    aria-label="Close" data-hs-overlay="#hs-update-password-data-{{ $user->id }}">
