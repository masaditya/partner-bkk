    ...
    <div
        ...
        <div
            ...
            <div class="flex items-center justify-between px-4 py-3 border-b dark:border-neutral-700">
                <h1 id="hs-add-data-category-modal-label" class="text-xl font-bold text-gray-800 dark:text-white">
                ...
                <button type="button"
                    ...
                    aria-label="Close" data-hs-overlay="#hs-add-data-category-modal">
