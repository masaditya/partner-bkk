    ...
    <div
        ...
        <div
            ...
            <div class="flex items-center justify-between px-4 py-3 border-b dark:border-neutral-700">
                <h1 id="hs-edit-data-{{ $status->id }}-label" class="text-xl font-bold text-gray-800 dark:text-white">
                    Ubah Data Status pekerjaan
                </h1>
                <button type="button"
                    ...
                    aria-label="Close" data-hs-overlay="#hs-edit-data-{{ $status->id }}">
                ...
                <form action="{{ route('master.status.update', $status->id) }}" method="POST">
                    ...
                    <div class="flex items-center justify-end px-4 py-3 gap-x-2">
                        <button type="button"
                            ...
                            data-hs-overlay="#hs-edit-data-{{ $status->id }}">
                            Tutup
                        </button>
                        <button type="submit"
