    ...
    <div
        ...
        <div
            ...
            <div class="flex items-center justify-between px-4 py-3 border-b dark:border-neutral-700">
                <h1 id="hs-edit-data-{{ $testimoni->id }}-label" class="text-xl font-bold text-gray-800 dark:text-white">
                    Ubah Data Jurusan
                </h1>
                <button type="button"
                    ...
                    aria-label="Close" data-hs-overlay="#hs-edit-data-{{ $testimoni->id }}">
            ...
            <div class="p-4 overflow-y-auto">
                ...
                <div class="p-2">
                    ...
                    <div class="mb-4.5">
                        ...
                        <select name="user_id" 
                            ...
                            @foreach ($users as $user)
                                <option value="{{ $user->id }}" {{ $user->id == $testimoni->user_id ? 'selected' : '' }}>
                                    {{ $user->name }}
                                </option>
                            @endforeach
                        </select>
                        <div id="preview-user" class="p-4 mt-3 border border-gray-200 rounded-md bg-gray-50 dark:bg-neutral-800 dark:border-neutral-700">
                            <div class="flex items-center gap-x-4">
                                <img src="{{ $testimoni->user->photo ?? 'https://placehold.co/48' }}" alt="Photo" class="object-cover w-12 h-12 rounded-full" onerror="this.src='https://placehold.co/48'" />
                                <div class="flex flex-col">
                                    <span class="text-sm font-medium text-gray-800 dark:text-white" id="preview-user-name">{{ $testimoni->user->name }}</span>
                                    <span class="text-sm text-gray-600 dark:text-neutral-400" id="preview-user-company">{{ $testimoni->user->company }}</span>
                                    <span class="text-sm text-gray-600 dark:text-neutral-400" id="preview-user-position">{{ $testimoni->user->position }}</span>
                                </div>
                            </div>
                        </div>
                        <script>
                    ...
                    <div class="mb-4.5">
                        ...
                        <textarea name="quote" placeholder="Masukkan kutipan" maxlength="200"
                            class="w-full rounded border-[1.5px] border-gray-200 bg-transparent px-5 py-3 font-normal text-gray-700 outline-none transition focus:border-primary active:border-primary dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary">{{ $testimoni->quote }}</textarea>
                    </div>
                        ...
                        <div class="flex items-center gap-4">
                            <div class="block">
                                <div class="w-24 h-24 rounded">
                                    <img src="{{ asset($testimoni->company_logo) }}" alt="Logo" id="previewImage" class="object-cover w-full h-full rounded">
                                </div>
                            </div>
                            <div>
                ...
                <div class="flex items-center justify-end px-4 py-3 gap-x-2">
                    <button type="button"
                        ...
                        data-hs-overlay="#hs-edit-data-testimoni-modal">
                        Tutup
                    </button>
                    <button type="submit"
