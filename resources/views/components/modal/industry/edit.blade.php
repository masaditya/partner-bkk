        ...
        <div
            ...
            <div class="flex items-center justify-between px-4 py-3 border-b dark:border-neutral-700">
                ...
                <button type="button"
                    ...
                    aria-label="Close" data-hs-overlay="#hs-edit-data-{{ $industry->id }}">
            ...
            <div class="p-4 overflow-y-auto">
                ...
                <form action="{{ route('master.industry.update', $industry->id) }}" method="POST">
                    @csrf
                    @method('PUT')
