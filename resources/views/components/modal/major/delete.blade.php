        ...
        <div class="relative flex flex-col bg-white shadow-lg rounded-xl dark:bg-neutral-900">
            <div class="absolute top-2 end-2">
                <button type="button"
                    ...
                    aria-label="Close" data-hs-overlay="#hs-delete-data-{{ $major->id }}">
            ...
            <div class="p-4 overflow-y-auto text-center sm:p-10">
                ...
                <h3 id="hs-delete-data-{{ $major->id }}-label"
                ...
                <div class="grid mt-6 gap-y-2">
                    <form action="{{ route('master.major.destroy', $major->id) }}" method="POST">
                        @csrf
                        @method('DELETE')
                        <button type="submit"
