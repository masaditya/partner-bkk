    ...
    <div
        ...
        <div
            ...
            <div class="flex items-center justify-between px-4 py-3 border-b dark:border-neutral-700">
                <h1 id="hs-edit-data-{{ $major->id }}-label" class="text-xl font-bold text-gray-800 dark:text-white">
                    Ubah Data Jurusan
                </h1>
                <button type="button"
                    ...
                    aria-label="Close" data-hs-overlay="#hs-edit-data-{{ $major->id }}">
            ...
            <div class="p-4 overflow-y-auto">
                ...
                <form action="{{ route('master.major.update', $major->id) }}" method="POST">
                    @csrf
                    @method('PUT')
