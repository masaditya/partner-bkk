    ...
    <div
        ...
        <div
            ...
            <div class="flex items-center justify-between px-4 py-3 border-b dark:border-neutral-700">
                <h1 id="hs-add-data-major-modal-label" class="text-xl font-bold text-gray-800 dark:text-white">
                    Tambah Data Jurusan
                </h1>
                <button type="button"
                    ...
                    aria-label="Close" data-hs-overlay="#hs-add-data-major-modal">
            ...
            <div class="p-4 overflow-y-auto">
                ...
                <form action="{{ route('master.major.store') }}" method="POST">
                    @csrf
                    <div class="p-2">
                        <!-- Name Field -->
                        <div class="mb-4.5">
                            ...
                            <input type="text" name="name" placeholder="Masukkan nama jurusan"
