...
<div id="dismiss-toast"
    ...
    <div class="flex items-center justify-between p-4">
        ...
        <button type="button"
            class="inline-flex items-center justify-center text-gray-800 rounded-lg opacity-50 shrink-0 size-5 hover:opacity-100 focus:outline-none focus:opacity-100 dark:text-white"
