<aside :class="sidebarToggle ? 'translate-x-0' : '-translate-x-full'"
    class="absolute left-0 top-0 z-9999 flex h-screen w-72.5 flex-col overflow-y-hidden bg-gray-800 duration-300 ease-linear dark:bg-gray-800 lg:static lg:translate-x-0"
        ...
        <nav class="px-4 py-4 lg:px-6" x-data="{selected: $persist('Dashboard')}">
            ...
            <div>
                ...
                <ul class="mb-6 flex flex-col gap-1.5">
                    ...
                    <li>
                        <a class="group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4"
                            href="{{ route('occupation.index') }}" @click="selected = (selected === 'Occupations' ? '':'Occupations')"
                            :class="{ 'bg-graydark dark:bg-meta-4': (selected === 'Occupations') && (page === 'Lowongan-Pekerjaan') }">

                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                stroke="currentColor" width="18" height="19">
                                <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <li>
                        <a class="group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4"
                            href="{{ route('applicant.index') }}" @click="selected = (selected === 'Applicant' ? '':'Applicant')"
                            :class="{ 'bg-graydark dark:bg-meta-4': (selected === 'Applicant') && (page === 'Applicant') }"
                            :class="page === 'Applicant' && 'bg-graydark'">
            ...
            <div>
                ...
                <ul class="mb-6 flex flex-col gap-1.5">
                    ...
                    <li>
                        <a class="group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4"
                            href="{{ route('article.index') }}" @click="selected = (selected === 'Artikel' ? '':'Artikel')"
                            :class="{ 'bg-graydark dark:bg-meta-4': (selected === 'Artikel') && (page === 'Artikel') }"
                            :class="page === 'Artikel' && 'bg-graydark'">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                stroke="currentColor" width="18" height="18">
                                <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <li>
                        <a class="group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4"
                            href="{{ route('partner.index') }}" @click="selected = (selected === 'Mitra' ? '':'Mitra')"
                            :class="{ 'bg-graydark dark:bg-meta-4': (selected === 'Mitra') && (page === 'Mitra') }"
                            :class="page === 'Mitra' && 'bg-graydark'">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                stroke="currentColor" width="18" height="18">
                                <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <li>
                        <a class="group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4"
                            href="{{ route('admin.index') }}" @click="selected = (selected === 'Admin' ? '':'Admin')"
                            :class="{ 'bg-graydark dark:bg-meta-4': (selected === 'Admin') && (page === 'Admin') }"
                            :class="page === 'Admin' && 'bg-graydark'">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" width="18" height="18"
                                viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-4.5">
                                <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <!-- Menu Item Dokumentation -->
                    <li>
                        <a class="group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4"
                            href="{{ route('documentation.index') }}" @click="selected = (selected === 'Dokumentasi' ? '':'Dokumentasi')"
                            :class="{ 'bg-graydark dark:bg-meta-4': (selected === 'Dokumentasi') && (page === 'Dokumentasi') }"
                            :class="page === 'Dokumentasi' && 'bg-graydark'">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="#dbdbdb" viewBox="0 0 256 256"><path d="M213.66,82.34l-56-56A8,8,0,0,0,152,24H56A16,16,0,0,0,40,40V216a16,16,0,0,0,16,16H200a16,16,0,0,0,16-16V88A8,8,0,0,0,213.66,82.34ZM160,51.31,188.69,80H160ZM200,216H56V40h88V88a8,8,0,0,0,8,8h48V216Zm-32-80a8,8,0,0,1-8,8H96a8,8,0,0,1,0-16h64A8,8,0,0,1,168,136Zm0,32a8,8,0,0,1-8,8H96a8,8,0,0,1,0-16h64A8,8,0,0,1,168,168Z"></path></svg>
                            Dokumentasi
                        </a>
                    </li>
                    <!-- Menu Item Dokumentation -->
                    ...
                    <li>
                        <a class="group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4"
                            href="#" @click.prevent="selected = (selected === 'DataMaster' ? '':'DataMaster')"
                            :class="{ 'bg-graydark dark:bg-meta-4': (selected === 'DataMaster') || (page === 'major' || page === 'employementStatus' || page === 'companyIndustry' || page === 'category') }">
                            ...
                            <ul class="flex flex-col gap-2 pl-6 mt-4 mb-3">
                                <li>
                                    <a class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white"
                                        href="{{ route('master.major.index') }}"
                                        :class="page === 'Jurusan' && '!text-white'">Data Jurusan</a>
                                </li>
                                <li>
                                    <a class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white"
                                        href="{{ route('master.status.index') }}"
                                        :class="page === 'Status-Pekerjaan' && '!text-white'">Data Status Pekerjaan</a>
                                </li>
                                <li>
                                    <a class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white"
                                        href="{{ route('master.industry.index') }}"
                                        :class="page === 'Perusahaan-Industri' && '!text-white'">Data Industri
                                        Perusahaan</a>
                                </li>
                                <li>
                                    <a class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white"
                                        href="{{ route('master.category.index') }}"
                                        :class="page === 'Kategori' && '!text-white'">Data Kategori Artikel</a>
                                </li>
                            </ul>
                        </div>
                        <!-- Dropdown Menu End -->
                    ...
                    <li>
                        <a class="group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4"
                            ...
                            @click="selected = (selected === 'Pengaturan' ? '':'Pengaturan')"
                    ...
                    <li>
                        <a class="group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4"
                            ...
                            @click="selected = (selected === 'Testimoni' ? '':'Testimoni')"
                            :class="{ 'bg-graydark dark:bg-meta-4': (selected === 'Testimoni') && (page === 'Testimoni') }"
                            :class="page === 'Testimoni' && 'bg-graydark'">
                            <svg xmlns="http://www.w3.org/2000/svg" class="fill-current" width="18" height="19" viewBox="0 0 256 256"><path d="M172,112a8,8,0,0,1-8,8H96a8,8,0,0,1,0-16h68A8,8,0,0,1,172,112Zm-8,24H96a8,8,0,0,0,0,16h68a8,8,0,0,0,0-16Zm68-12A100.11,100.11,0,0,1,132,224H48a16,16,0,0,1-16-16V124a100,100,0,0,1,200,0Zm-16,0a84,84,0,0,0-168,0v84h84A84.09,84.09,0,0,0,216,124Z"></path></svg>
